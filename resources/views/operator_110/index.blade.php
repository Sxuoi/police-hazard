...
<div x-data="{ 
            ...
            <table class="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                    <tr class="border-b border-[var(--color-surface-600)] text-gray-400 text-sm">
                        ...
                        <th class="py-3 px-4 font-medium">Unit Armada</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-[var(--color-surface-600)]/50 hover:bg-[var(--color-surface-700)]/50 transition-colors">
                        ...
                        <td class="py-3 px-4 text-gray-300">{{ $report->unit->nama_unit ?? '-' }}</td>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-show="openAddModal" x-cloak>
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!-- Modal Panel -->
            <div class="relative inline-block align-bottom bg-[var(--color-surface-800)] border border-[var(--color-surface-600)] rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full"
                 x-show="openAddModal"
                 x-transition:enter="ease-out duration-300"
                    ...
                    <div class="px-6 pt-5 pb-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="no_tiketing" required value="TKT-{{ time() }}" class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-1">Unit Armada Tugas</label>
                                <select name="unit_id" required class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] appearance-none">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="jenis_gangguan" required placeholder="Contoh: Kecelakaan Lalu Lintas, Perkelahian..." class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]">
                            </div>
                            <div class="sm:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="nama_pelapor" required placeholder="Nama lengkap..." class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-300 mb-1">No HP Pelapor</label>
                                    <input type="text" name="no_hp_pelapor" required placeholder="Contoh: 0812..." class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-300 mb-1">Jenis No HP</label>
                                    <select name="jenis_no_hp_pelapor" required class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="tempat_kejadian" required rows="2" placeholder="Detail alamat lokasi..." class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]"></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-1">Waktu Kejadian</label>
                                <input type="datetime-local" name="waktu_kejadian" required class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] [color-scheme:dark]">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-1">Waktu Dilaporkan</label>
                                <input type="datetime-local" name="waktu_dilaporkan" required value="{{ date('Y-m-d\TH:i') }}" class="w-full bg-[var(--color-surface-900)] border border-[var(--color-surface-600)] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] [color-scheme:dark]">
                            </div>
                        </div>
                    </div>
