        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-[var(--color-surface-800)] rounded-2xl border border-[var(--color-surface-600)] p-6">
                ...
                <dl class="grid grid-cols-2 gap-x-8 gap-y-4 text-sm">
                    <div><dt class="text-gray-500">Tanggal Mulai</dt><dd class="text-white mt-1">{{ \Carbon\Carbon::parse($operation->start_date)->format('d M Y') }}</dd></div>
                    <div><dt class="text-gray-500">Tanggal Selesai</dt><dd class="text-white mt-1">{{ $operation->end_date ? \Carbon\Carbon::parse($operation->end_date)->format('d M Y') : 'Tanpa batas' }}</dd></div>
