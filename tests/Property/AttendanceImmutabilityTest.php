...
class AttendanceImmutabilityTest extends PostgresPropertyTestCase
{
    ...
    private function seedSupport(): void
    {
        ...
        DB::table('assignments')->insert(['id' => $this->assignmentId, 'officer_id' => $this->officerId, 'location_id' => $this->locationId, 'operation_id' => $opId, 'saker_id' => $this->sakerId, 'assigned_saker_id' => $this->sakerId, 'start_date' => now()->toDateString(), 'status' => 'active', 'assigned_by' => $this->officerId, 'created_at' => now(), 'updated_at' => now()]);
    }
}
